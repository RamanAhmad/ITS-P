...
public class KerberosSim {
	...
	public static void main(String args[]) {
		...
		System.out.println("Initialisiere Kerberos-System...");
		thisSession.initKerberos(userName, password, serverName, tgsName);
		System.out.println("Kerberos-System initialisiert.\n");
		...
		if (password != null) {
			...
			System.out.println("Benutzeranmeldung beim KDC...");
			...
			if (!loginOK) {
				...
				System.out.println("Fordere Zugriff auf Fileserver an...");
