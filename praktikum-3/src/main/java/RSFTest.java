...
public class RSFTest {
    ...
    public void readPrivKey() {
        ...
        try {
            ...
            IOException ex = var8;
            this.Error("Fehler beim Lesen des private keys!", ex);
        }
        ...
        try {
            ...
            NoSuchAlgorithmException ex = var7;
            this.Error("Es existiert keine KeyFactory fuer RSA.", ex);
        }
        ...
        try {
            ...
            InvalidKeySpecException ex = var6;
            this.Error("Fehler beim Konvertieren des Schluessels.", ex);
        }
    ...
    public void readPubKey() {
        ...
        try {
            ...
            IOException ex = var8;
            this.Error("Fehler beim Lesen des public keys!", ex);
        }
    ...
    public void convertSSFFile() {
        try {
            ...
            Exception ex = var9;
            this.Error("Fehler beim Schreiben der Dokumentendatei oder Lesen der .ssf-Datei!", ex);
        }
    ...
    public void decryptKey() {
        try {
            ...
            this.Error("Keine Implementierung fuer RSA vorhanden!", ex);
        } catch (InvalidKeyException var3) {
            InvalidKeyException ex = var3;
            this.Error("Falscher Algorithmus?", ex);
        } catch (Exception var4) {
            Exception ex = var4;
            this.Error("Fehler bei der Entschluesselung des geheimen Schluessels", ex);
        }
    ...
    public boolean verifySignature() {
        ...
        try {
            ...
            ex = var6;
            this.Error("Fehler beim Ueberpruefen der Signatur!", ex);
        ...
        try {
            ...
            ex = var4;
            this.Error("Fehler beim Verifizieren der Signatur!", ex);
        }
